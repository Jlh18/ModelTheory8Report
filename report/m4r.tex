...
\definecolor{commentcolor}{rgb}{0.6, 0.6, 0.6}   % grey
...
% ? In introduction + overview per section mention overview of Ax-Grothendieck on pg 22

% ? Make clear at end of proof of AxG that we still need to prove all the lemmas
