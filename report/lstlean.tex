...
open, export, override, inductive, with, without,
...
calc, have, show, suffices, by, forall, Pi, fun,
if, dif, then, else, assume, obtain, from, aliases, register_simp_ext, unless, break, continue,
