...
\begin{dfn}[Language of rings]
    ...
    \begin{itemize}
      \item The \linkto{dfn_nat}{natural numbers} are defined as inductive types
      \item \linkto{dfn_list}{Lists} are defined as inductive types
      \item The \linkto{dfn_int}{integers} can be defined as inductive types
    \end{itemize}
...
To \linkto{algebraic_objects_iff_models}{show this} we must write down the theories of
