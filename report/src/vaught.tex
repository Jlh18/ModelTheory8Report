...
In \code{flypitch} this construction is called \code{term\_model}.
...
All of this is done in \code{flypitch} and can mostly be found in \code{henkin.lean}.
An overview follows.
...
In \code{flypitch} they design a general process of taking the colimit
